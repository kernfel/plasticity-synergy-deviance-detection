...
\begin{figure}
    ...
    \caption{%
        ...
        \textbf{F} Contribution $C$ of TA to greater firing in \dev{} than \std{}, see \EQ{hist_contrib}. Contributions greater than those of the membrane voltage are shown in red.
        \textbf{G} Contribution of TA (red) and $V_m$ (blue), weighted by difference in spike probability, and averaged across neurons ($\bar C$, see \EQ{mean_contrib}).
        \textbf{H} Weighted average contribution $\bar C$ of TA and $V_m$ as in panel G, summarized across data sets. Plotted are the median (solid line) and inter-quartile range (shaded area).
    }
